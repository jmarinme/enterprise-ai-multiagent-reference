...
## 2026-08-07 — Sprint 01 started with PBI-00-08 and PBI-00-09 still open

**Decision:** `CLAUDE.md` §14 requires either Sprint 00's exit criteria to be satisfied or the user's explicit risk acceptance before starting Sprint 01 work. PBI-00-08 (infrastructure tests/validation scripts) and PBI-00-09 (consolidate ADRs/evidence) remain unchecked in `docs/sprint_00/README.md`. Before starting PBI-01-01 (Supervisor orchestration framework, Sprint 01), this conflict was raised explicitly; the user responded: *"I explicitly accept closing Sprint 0 and starting Sprint 1 because PBI-00-08 and PBI-00-09 have already been satisfied incrementally through previous PBIs."*

**Deviation/status change:** This is the user's explicit acceptance of the CLAUDE.md §14 risk, recorded verbatim for traceability. Their stated rationale (PBI-00-08/09 satisfied incrementally) is **not** independently verified or acted upon here: no ADR files exist yet under `docs/Architecture/adr/` (PBI-00-09's literal deliverable), and no dedicated infrastructure-test scripts beyond what already runs inside the CI pipeline exist (PBI-00-08's literal deliverable). Per the user's own instruction ("do not introduce unrelated changes"), PBI-00-08/09's checkboxes in `docs/sprint_00/README.md` were deliberately **not** marked complete as part of this decision — that remains open, separate work, tracked independently of Sprint 01's progress.

**How to apply:** Sprint 00 should still be formally closed (PBI-00-08, PBI-00-09, and this deviation reflected in the sprint retrospective) before the project is considered to have a fully compliant Sprint 00 exit per `CLAUDE.md` §12/§14 — this is a known, accepted gap, not a resolved one.
